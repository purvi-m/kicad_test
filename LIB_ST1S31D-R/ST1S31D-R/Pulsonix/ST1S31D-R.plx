...
//290325/769493/2.49/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ST1S31D-R" (originalName "ST1S31D-R")
	...
	(compDef "ST1S31D-R" (originalName "ST1S31D-R") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "PGND") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "SW") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VINSW") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "PG") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ST1S31D-R"))
		...
		(attr "Manufacturer_Part_Number" "ST1S31D-R")
		(attr "Mouser Part Number" "511-ST1S31D-R")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=511-ST1S31D-R")
		(attr "Arrow Part Number" "ST1S31D-R")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/st1s31d-r/stmicroelectronics")
		(attr "Description" "STMicroelectronics, ST1S31D-R Step-Down Switching Regulator 3A Adjustable 8-Pin, SOIC")
		(attr "<Hyperlink>" "http://www.st.com/content/ccc/resource/technical/document/datasheet/group3/ec/e5/76/72/e8/25/4d/47/DM00051589/files/DM00051589.pdf/jcr:content/translations/en.DM00051589.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ST1S31D-R.stp")
